...
open class FPNTextField: UITextField {
    ...
    private var selectedCountryFromPicker: FPNCountry?
    ...
    @objc private func displayCountries() {
        ...
        case .picker:
            ...
            pickerView.didSelect = { [weak self] country in
                self?.selectedCountryFromPicker = country
            }
    ...
    @objc private func dismissCountries() {
        ...
        guard let selectedCountryFromCountry = selectedCountryFromPicker else { return }
        fpnDidSelect(country: selectedCountryFromCountry)
    }
